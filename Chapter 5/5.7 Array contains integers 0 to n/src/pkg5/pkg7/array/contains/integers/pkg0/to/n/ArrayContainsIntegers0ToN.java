 ...
 */
package pkg5.pkg7.array.contains.integers.pkg0.to.n;
 ...
 * 0(n) time?
 */
public class ArrayContainsIntegers0ToN {
    /* SOLUTION
    ...
    public static void main(String[] args) {
        Integer[] a = {0, 1, 2, 4, 5, 6, 7, 8, 9, 10};
        ArrayList<Integer> list = new ArrayList<Integer>(Arrays.asList(a));
        Collections.shuffle(list);
        System.out.println(findMissingInteger(list));
    }
}
