package pkg4.pkg7.find.first.common.of.two.nodes;
 ...
 */
public class FindFirstCommonOfTwoNodes {
    ...
    public static TreeNode findFirstCommonAncestor(TreeNode root, TreeNode n1, TreeNode n2) {
        ...
        if (root == n1 && contains(root, n2) || root == n2 && contains(root, n1)) {
            return root;
        }
    ...
    public static void main(String[] args) {
        ...
        //System.out.println();
        System.out.printf("FirstCommonAncestor of %s, %s: %s", n1, n6, findFirstCommonAncestor(n4, n1, n6));
        System.out.println();
        System.out.printf("FirstCommonAncestor of %s, %s: %s", n1, n7, findFirstCommonAncestor(n4, n1, n7));
        System.out.println();
        System.out.printf("FirstCommonAncestor of %s, %s: %s", n4, n5, findFirstCommonAncestor(n4, n4, n5));
        System.out.println();
        System.out.printf("FirstCommonAncestor of %s, %s: %s", n5, n5, findFirstCommonAncestor(n4, n5, n5));
        System.out.println();
    }
}
