 ...
 */
package pkg7.pkg5.cut.squares.in.half;
...
public class CutSquaresInHalf {
     ...
     * @param x4 The x coordinate of the lower right corner of the second
     * square.
     * @param y4 The y coordinate of the lower right corner of the second
     * square.
     * @return An array list containing two integers, the slope and the
     * intercept of the line. if line is vertical (x = c) and horizontal (y =
     * c), return the constant only, if two square coincides, return the x, y of
     * the points.
     */
    ...
    public static void main(String[] args) {
        CutSquaresInHalf instance = new CutSquaresInHalf();
        double[] arr = instance.cutInHalf(-4, 10, -1, 7, -3, 5, 1, 1);
